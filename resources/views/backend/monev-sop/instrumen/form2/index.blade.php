    ...
    <div class="modal fade" id="modalAddInstrumen" tabindex="-1" aria-labelledby="add_master_label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form_store_instrumen" action="{{ route('instrumen-form2.store') }}" method="POST" autocomplete="off">
                    @csrf
    ...
    <script>
        ...
        function fill_datatable() {
            let fill_datatable = $('#instrumen_table').DataTable({
                ...
                ajax: {
                    url: '{{route("instrumen-form2.datatable")}}',
                    dataSrc: 'data',
                    data : function(param){
            ...
            $(document).ready(function () {
                $('#instrumen_table tbody').on('click', '.viewdetails', function () {
                    ...
                    if (this_id > 0) {
                        let url = "{{ route('instrumen-form2.ajax_show', [':this_id']) }}";
        ...
        function deleteForm(param) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let action = "{{ route('instrumen-form2.delete', ':id') }}".replace(':id', id);
        ...
        function showAddModal(){
            $('#modalAddInstrumen').modal('show');
            var url = "{{ route('instrumen-form2.ajax_show', [0]) }}";
        ...
        function showModalFilter(){
            ...
            var url = "{{ route('instrumen-form2.ajax_filter') }}";
