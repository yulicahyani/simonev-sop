...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <form id="surveyForm" action="{{ route('monev-sop.sop.form-monev.f01.store') }}" enctype="multipart/form-data" method="POST" autocomplete="off">
                @csrf
            <!--begin::Card-->
            <div class="card mb-5">
                <!--begin::Card header-->
                                ...
                                <td>
                                    <a href="{{ route('file.view', ['filepath' => encrypt($sop->filepath)]) }}" 
                                       ...
                                       data-bs-trigger="hover">
                                        <i class="bi bi-file-earmark-arrow-down-fill fs-5"></i> Unduh
                                    </a>
                                </td>
                            </tr>
            ...
            <div class="card mb-5">
                ...
                <div class="card-header border-0 pt-6">
                    <!--begin::Card title-->
                    <div class="card-title">
                        <h3 class="fw-bold my-1"> B. Monitoring Pelaksanaan SOP</h3>
                    </div>
                    <!--begin::Card title-->
                </div>
                <!--end::Card header-->
            ...
            <div class="card mb-5">
                ...
                <div class="card-header border-0 pt-6">
                    <!--begin::Card title-->
                    <div class="card-title">
                        <h3 class="fw-bold my-1"> C. Evaluasi Penerapan SOP</h3>
                    </div>
                    <!--begin::Card title-->
                </div>
                <!--end::Card header-->
            ...
            <div class="card mb-5 text-center">
                ...
                <div class="card-header border-0 pt-6 d-flex justify-content-center">
                    <!--begin::Card title-->
                    <div class="card-title">
                        <h3 class="fw-bold my-1"> Tanda Tangan/Paraf Pelaksana SOP</h3>
                    </div>
                    <!--begin::Card title-->
                </div>
                <!--end::Card header-->
                ...
                <div class="card-body pt-5 border-top" >
                    ...
                    {{-- <a href="{{route('monev-sop.sop.form-monev.index', encrypt($sop->id))}}" data-theme="light" class="btn btn-light btn-active-light-primary">
                        <i class="bi bi-arrow-left-circle fs-4"></i>
                        Batal dan Kembali
                    </a>
                    <button type="submit" class="btn btn-primary px-5 ms-5">Kirim Jawaban Monev</button> --}}
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary ms-5"><i class="fa-solid fa-floppy-disk fs-5 me-2"></i>Simpan Jawaban</button>
                </div>
            </div>
            <!--end::Card-->
            </form>
...
@section('js')
    ...
    <script>
        // document.addEventListener("DOMContentLoaded", function () {
            ...
            const base64Signature = "{{isset($result_monev) ? $result_monev->ttd_base64_pelaksana_sop : ''}}"; // truncated
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            const tanggalPengisian = @json(isset($result_monev) && !empty($result_monev->tgl_pengisian_f01) 
            ? $result_monev->tgl_pengisian_f01 
            : 'today');
    ...
    questions.forEach((q, i) => {
      ...
      if (q.aspek === "Monitoring Pelaksanaan SOP") {
        qCard.innerHTML = `
        ...
        ${q.catatan_des ? ` 
        <label for="note${i}" class="fw-semibold mt-3 d-block">${q.catatan_des}</label>
        <textarea class="note-input form-control" id="note${i}" name="notes[${i}]" placeholder="Tambahkan catatan jika jawaban tidak...">${old.note || ''}</textarea>
        ` : ''}
        <input type="hidden" name="question_ids[${i}]" value="${q.id}">
        <input type="hidden" name="f01_ids[${i}]" value="${old.f01_id}">
        <input type="hidden" name="answers[${i}]" id="answer${i}" value="${old.answer || ''}">
      `;
        firstContainer.appendChild(qCard);
      } else if (q.aspek === "Evaluasi Penerapan SOP") {
        qCard.innerHTML = `
        <div class="question-text">${counters[q.aspek]}. ${q.instrumen}</div>
        <div class="emoji-container">
          <div class="emoji-option">
      ...
      `;
        ...
        qCard.innerHTML = `
        <div class="question-text">${i}. ${q.instrumen}</div>
        <div class="emoji-container">
          <div class="emoji-option">
            <div class="lottie-box yes" id="yes${i}"></div>
            <div class="emoji-label">YA</div>
