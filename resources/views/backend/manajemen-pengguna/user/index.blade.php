        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="user_table" style="width:100%">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <p class="fs-4 my-auto" id="modal_filter_title" >Filter Data Pengguna</p>
    ...
    <script>
        ...
        function fill_datatable() {
            $('#user_table').DataTable({
                ...
                stateSave: true,
                searching: true,
                scrollX: true, // ini wajib untuk horizontal scroll
                ...
                ajax: {
                    ...
                    data : function(param){
                        ...
                        param.role_code = $('#role_filter').val();
                        param.unit_id = $('#unit_filter').val();
        ...
        function showModalFilter(){
            ...
            var url = "{{ route('user.ajax_filter') }}";
